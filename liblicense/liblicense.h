 ...
 * LL_ATTRIBUTE_URI_PERMITS, #ll_get_requires and LL_ATTRIBUTE_URI_PROHIBITS functions.
 *
 ...
 * by the LL_ATTRIBUTE_URI_PERMITS, #ll_get_requires and LL_ATTRIBUTE_URI_PROHIBITS
 * functions.
 *
